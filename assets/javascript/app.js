$(document).ready(function() {
  ...
  var questions = [
    {
      question:
        "Where did the Wright Brothers make the first controlled power airplane flight?",
      choices: ["Nags Head", "Hatteras Island", "Wilmington", "Kitty Hawk"],
      answer: 3
    },
    {
      question:
        "What carnivorous plant is native to the subtropical wetlands in North Carolina?",
      choices: [
    ...
    {
      question:
        "This Interstate Highway runs across the United States from Wilmington, NC to Barstow, CA",
    ...
    {
      question:
        "The USS North Carolina was dedicated as a memorial and museum in which city?",
      choices: ["Southport", "Wilmington", "New Bern", "Beaufort"],
      answer: 1
    },
    {
      question:
        "This lighthouse was moved 2,900 feet inland due to coastal erosion.",
      choices: [
    ...
    {
      question:
        "The waters off the North Carolina coast are often called what due to the numerous shipwrecks?",
      choices: [
        "Shipwreck Bay",
        "The Deadly Shoals",
